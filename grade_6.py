...
# 🔤 دالة لتعديل النص العربي (عشان الحروف تطلع صح من اليمين)
...
PATH_TO_SERVICE_ACCOUNT = "attendance-streamlit-app-c3aa8-firebase-adminsdk-fbsvc-1415d36635.json"
...
def generate_pdf(student_name, df):
    ...
    # إعادة تشكيل النصوص العربية داخل الجدول
